...
echo "==> Building static lib for $SIM_TARGET"
cargo build -p anki-ffi --release --target "$SIM_TARGET"

echo "==> Building static lib for $DEVICE_TARGET"
cargo build -p anki-ffi --release --target "$DEVICE_TARGET"
