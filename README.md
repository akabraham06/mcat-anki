...
Beyond the AI-feature eval above, the scoring engine, performance, sync and
crash-safety each have a one-command proof and a write-up. All are **offline and
...
Background docs: **[`docs/model-descriptions.md`](./docs/model-descriptions.md)**
(the three models, grounded in the code), **[`docs/brainlift.md`](./docs/brainlift.md)**
(what was built and why), and **[`docs/sync-conflict-rule.md`](./docs/sync-conflict-rule.md)**.
