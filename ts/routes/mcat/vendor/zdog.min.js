...
/* eslint-disable */
/*
 * Vendored offline copy of Zdog v1.1.3 (https://zzz.dog) — MIT, Copyright 2020
 * Metafizzy. See ./zdog.LICENSE. Kept local so Anki stays offline-first (no
 * runtime CDN). This is the upstream dist bundle, wrapped so a bundler
 * (Vite/Rollup) links it as a normal ES module: we shadow `module`, `define`
 * and `require` (forcing Zdog's browser-global branch) and bind `this` to a
 * capture object, then re-export the assembled Zdog namespace.
 */
const __zdog = {};
...
}).call(__zdog, undefined, undefined, undefined);

export default __zdog.Zdog;
